...
import EventItem from "./itemActivity/EventItem.jsx";

const style = {
  wrapper: `w-full mt-8 border border-[#151b22] rounded-xl bg-[#303339] overflow-hidden`,
  title: `bg-[#262b2f] px-6 py-4 flex `,
...
const ItemActivity = () => {
  ...
  return (
    <div className={style.wrapper}>
      <div className={style.title} onClick={() => setToggle((prev) => !prev)}>
